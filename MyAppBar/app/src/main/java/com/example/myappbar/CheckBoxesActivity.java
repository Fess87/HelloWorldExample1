        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mBankCardChkBx.isChecked()){
                    Toast.makeText(CheckBoxesActivity.this, mInputMoney.getText().toString()+ " " + getString(R.string.forPayCardTxt)+ " " + mInputInfo.getText().toString(), Toast.LENGTH_LONG).show();
                }
                if(mMobilePhoneChkBx.isChecked()){
                    Toast.makeText(CheckBoxesActivity.this, mInputMoney.getText().toString()+ " " + getString(R.string.forPayMobileTxt)+ " " + mInputInfo.getText().toString(), Toast.LENGTH_LONG).show();
                }
                if (mCashAddressChkBx.isChecked()){
                    Toast.makeText(CheckBoxesActivity.this, mInputMoney.getText().toString() + " " +getString(R.string.forPayOnAddressTxt)+ " " + mInputInfo.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
