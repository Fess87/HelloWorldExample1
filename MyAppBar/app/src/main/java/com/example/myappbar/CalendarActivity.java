        ...
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStartDate > mEndDate){
                    Toast.makeText(CalendarActivity.this, getString(R.string.fault), Toast.LENGTH_LONG).show();
                    mChooseStartDate.setText(getString(R.string.dateNameTaskStart));
                    mChooseEndDate.setText(getString(R.string.dateNameTaskEnd));
                } else {
                    Toast.makeText(CalendarActivity.this, getString(R.string.start)+ " " + mStartDateTxt+ " " + getString(R.string.end) + " " + mEndDateTxt, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
